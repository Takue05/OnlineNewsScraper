...
class SundayMailSpider(scrapy.Spider):
    name = 'sundaymail'
    ...
    def start_requests(self):
        categories = {
            'https://www.heraldonline.co.zw/single-category/?tag=business&category=sundaymail': 'Business',
            'https://www.heraldonline.co.zw/single-category/?tag=iopinion-&-analysis&category=sundaymail': 'Politics',
            'https://www.heraldonline.co.zw/single-category/?tag=society&category=sundaymail': 'Arts/Culture/Celebrities',
            'https://www.heraldonline.co.zw/single-category/?tag=sports&category=sundaymail': 'Sports'
        }
    ...
    def parse_article(self, response):
        ...
        item['newspaper'] = 'The Sunday Mail'

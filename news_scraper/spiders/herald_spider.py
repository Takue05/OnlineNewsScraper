...
class HeraldSpider(scrapy.Spider):
    ...
    def start_requests(self):
        categories = {
            'https://www.heraldonline.co.zw/single-category/?tag=business&category=herald': 'Business',
            'https://www.heraldonline.co.zw/single-category/?tag=national&category=herald': 'Politics',
            'https://www.heraldonline.co.zw/single-category/?tag=arts-&-culture&category=herald': 'Arts/Culture/Celebrities',
            'https://www.heraldonline.co.zw/single-category/?tag=sports&category=herald': 'Sports'
        }
